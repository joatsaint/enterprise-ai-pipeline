...
- [ ] **Finish the Phase 1 spine** — create the folder tree (`articles/`, `pending/`,
  `approved/`, `scheduled/`, `published/`, `research/`) + a thin `content-engine/CLAUDE.md`
  pointer, so the generator has somewhere to write. *(CONTENT_OS.md ✓, TASKS.md ✓ — folders + CLAUDE.md remaining.)*
...
- [x] ~~CONTENT_OS.md created (v1.2) — the content-engine brain~~ (May 31)
- [x] ~~ORCHESTRATOR.md drafted — root cross-project map (forward-design)~~ (May 31)
- [x] ~~Five content pillars + trend-miner `site:` query list captured in CONTENT_OS~~ (May 31)
