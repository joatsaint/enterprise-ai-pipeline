...
All projects
YouTube-downloader
This started as a YouTube transcriber downloader project but has grown to emcompass both the Youtube transcriber and the Youtube to pdf generator.
...
Finding My Youtube Voice
Last message 4 minutes ago
Gen X IT content with nostalgic references
Last message 2 hours ago
Task scheduler report generation for youtube-downloader
Last message yesterday
Implementing Claude Code best practices
Last message yesterday
Lead magnet PDF review using template guide
Last message 2 days ago
YouTube downloader project 4 status Session 11
Last message 2 days ago
YouTube downloader project 3 status
Last message 2 days ago
Implementing transcript analysis for YouTube or Downloader project
Last message 4 days ago
Lamar University Story - Don't Upgrade During A Hurricane
Last message 5 days ago
LinkedIn image layout specifications
Last message 6 days ago
Rewriting transcript in voice.md style
Last message 6 days ago
Evaluating essential Claude code repositories
Last message 6 days ago
Engaging LinkedIn article layout and format
Last message 7 days ago
YouTube-downloader project 2 status and marketing execution
Last message 2 weeks ago
Finding your IT Image and voice for YouTube
Last message 2 weeks ago
Building a LinkedIn content strategy with Canva
Last message 2 weeks ago
Evaluating OmniSocials agent skills integration
Last message 2 weeks ago
YouTube-downloader project 3 status and marketing execution
Last message 2 weeks ago
Evaluating Prolific studies by hourly rate
Last message 2 weeks ago
YouTube-downloader project 4 status and marketing execution
Last message 2 weeks ago
Using AI to liberate yourself from the grind
Last message 2 weeks ago
AI governance career transition for IT professionals
Last message 2 weeks ago
Naming your LinkedIn newsletter
Last message 2 weeks ago
Orchestrating YouTube downloader project architecture
Last message 2 weeks ago
YouTube downloader project architecture
Last message 2 weeks ago
YouTube-downloader project 1 status and marketing execution
Last message 2 weeks ago
Memory
Only you
Purpose & context Randy is building a business positioning himself as an IT-to-AI transition expert, targeting IT professionals with 15–25 years of experience. The flagship project is a YouTube downloader tool (github.com/joatsaint/youtube-downloader) used as a lead generation vehicle. Success looks like generating paid product sales, building an audience of transitioning IT professionals, and establishing Randy as a credible voice in the IT-to-AI space. Key project documents governing this work: MASTERPLAN.md — stage-by-stage roadmap PROJECTCONTEXT.md — overall positioning and strategy CLAUDE.md — session and workflow instructions docs/ folder — content drafts, marketing systems, product ideas, atomization rules, decisions, brand voice A secondary future project has been identified: a healthcare plan analyzer agent that takes user intake questions, pulls government-subsidized plan data, and produces objective ranked recommendations (removing commission-based broker conflicts of interest). Surface this idea when the youtube-downloader project is complete or when Randy asks for project ideas. --- Current state Randy is in Stage 5 of the MASTERPLAN. Completed or in-progress items: Email 2 (Mailchimp): Workaround settled — manual send as a campaign when a subscriber signs up (no automated sequence due to Mailchimp paid-plan constraint; Email 1 doesn't exist since the PDF is delivered via browser redirect). Email 2 draft has been proofread and corrected; updated CONTENTDRAFTS.md produced with fixes applied. LinkedIn Post 2: Copy pulled and scheduled for Wednesday April 29, 2026 at 8 AM CST. Important: LinkedIn comments cannot be pre-scheduled — the landing page link must be manually posted as the first comment the moment each post goes live. This applies to both Post 1 and Post 2. LinkedIn Post 1: Never posted; still in READY status. Recruiter-facing AI talking points sheet: Produced as a .docx covering pipeline architecture, data extraction, prompt engineering, Claude Code, automation/deployment, AI market research methodology, enterprise IT transferable skills, and a known gaps/certification targets table. Stage 5 remaining items: Email 3 (soft pitch to paid PDF) First Quora answer First Facebook group post Personal outreach to carousel engagers Stage 6 requires a paid PDF published on Gumroad before advancing to Stage 7 (first paid sale). --- Approach & patterns Randy works in session-based bursts and typically provides an explicit priority list and project briefing at the start of each session. Prefers step-by-step confirmation pauses on platform setup tasks rather than bulk instructions. Wants Claude to track cross-session reminders explicitly — do not assume context carries over automatically. Uploads key project documents at session start to re-establish context.

Last updated 3 days ago

Instructions
LinkedIn article images are landscape in layout. LinkedIn post images are vertical layout. When I ask for an image created, ask if it is a Post or an Article image. --- start of LinkedIn Post prompt ---LinkedIn Post instructions: Create a high-impact, visually engaging LinkedIn feed post image in vertical format optimized for LinkedIn engagement. The image should be designed specifically for a LinkedIn feed post and sized to fit LinkedIn’s recommended dimensions while maintaining strong readability on both desktop and mobile. Image requirements: * Final image size: 1376 x 768 * Include a clean 1-inch white border around the entire image * Style: humorous but realistic * Tone: professional with subtle humor that supports the article’s core message * The visual should immediately communicate the emotional or strategic point of the article without looking cartoonish or overly exaggerated * Use cinematic lighting, realistic people/environments, and authentic workplace or business-related details where appropriate * Prioritize strong visual storytelling over clutter Text overlay requirements: * Integrate the article title naturally into the image as a clean, professional text overlay * The text placement should enhance the composition without blocking key visual elements * Typography should feel modern, polished, and LinkedIn-appropriate * Make sure the title remains readable on mobile devices * Do not overcrowd the image with extra text Creative direction: * Read the article/story carefully and identify: * the core message * the emotional tone * the business or career lesson * the irony, humor, or contradiction that can be visualized * Use your best judgment to create a single compelling image concept that would stop professionals mid-scroll in the LinkedIn feed * The image should feel like something created by a top-tier editorial creative team for a viral LinkedIn post Article/story to visualize: [PASTE ARTICLE OR STORY HERE] --- end of LinkedIn Post prompt --- --- start of LinkedIn Article prompt --- Create a professional LinkedIn feed image based on the article or story provided below. Requirements: * Image size: 1376 x 768 * Add a clean 1-inch white border around the entire image * Style: realistic with subtle humor * Format: optimized for LinkedIn feed posts * The image should feel modern, professional, and highly engaging in the LinkedIn feed Creative Direction: * Read the article/story carefully * Identify the core message, emotional tone, and key business or career insight * Create a visually compelling scene that communicates the main idea instantly * Use humor naturally and intelligently without making the image feel cartoonish or childish * Prioritize realism, strong composition, and scroll-stopping visual storytelling Text Overlay: * Integrate the article title into the image as a clean text overlay * The title should be easy to read on desktop and mobile * Position the text so it does not interfere with the main visual message * Use modern, professional typography appropriate for LinkedIn Visual Style: * Cinematic lighting * Realistic people and environments * Authentic workplace, business, or technology details when relevant * Minimal clutter * High-end editorial quality similar to a viral LinkedIn post or business magazine feature Goal: Create an image that immediately grabs attention in the LinkedIn feed while reinforcing the article’s message through both humor and realism. Article/Story: [PASTE ARTICLE OR STORY HERE] --- end of LinkedIn Article prompt ---

Files
10% of project capacity used
Search mode

joatsaint/video-to-pdf-guide-creator
master
...
joatsaint/enterprise-ai-pipeline
master

GITHUB


ART2_Vendor_Content_Week_May21.md
Drive
...
Randy_AI_Questions_YouTube_Scripts.md
316 lines
...
Claude - IT_WarStories_Chapter_Template_Prompt.md
140 lines
...
DeepSeek_PORTFOLIO_MASTER_TRACKER.md
196 lines
...
Randy_Skiles_Voice_Profile_v2.docx
353 lines
...
LinkedIn Comment with Lead Magnet 7 Skills
2 lines
...
5-13-2026 LinkedIn Publishe Schedule.txt
16 lines
...
Whiteboard_Animation_Video_Creation.txt
143 lines
...
All LinkedIn Articles as of 5-14-2026.md
1,204 lines
...
paul_2011_voice_profile_and_ai_style_transfer_prompt.md
395 lines

md


claudecodecarouselvideohiggsfieldkieaifreebie.pdf
pdf


steel_server_room_lead_magnet_v7_operator_sprint.pdf
pdf



dontpanic_post_comp.png
png
...
- Format: Post image (vertical 1080x1350) — NOT article landscape format
